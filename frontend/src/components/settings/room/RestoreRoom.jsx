...
import { useRestoreRoom, useBadRooms } from "../../../shared/hooks/index.js"

export const RestoreRoom = () => {
    const { restoreRoom, isLoading } = useRestoreRoom();

    const { getHotelRooms, allHotelRooms, isFetching } = useBadRooms();
    ...
    const handleUpdate = (event) => {
        try {
            ...
            restoreRoom(formState.email.value, formState.password.value, room);
    ...
    return (
        ...
        <div className='new-post-container'>
            <span className='new-post-title'>Restore room</span>
