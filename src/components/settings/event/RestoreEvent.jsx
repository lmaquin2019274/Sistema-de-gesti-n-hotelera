...
import { useRestoreEvent, useBadEvents } from "../../../shared/hooks/index.js"

export const RestoreEvent = () => {
    const { restoreEvent, isLoading } = useRestoreEvent();

    const { getHotelEvents, allHotelEvents, isFetching } = useBadEvents();
    ...
    const handleUpdate = (event) => {
        try {
            ...
            restoreEvent(formState.email.value, formState.password.value, evento);
    ...
    return (
        ...
        <div className='new-post-container'>
            <span className='new-post-title'>Restore event</span>
